...
<x-layouts.app :title="__('Employee')">
    <div class="relative h-full flex-1 p-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 mt-1">
        ...
        <form action="{{ route('employee.update', ['employee_id' => $employee->employee_id]) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div id="dependents-input-container">
                    <div class="grid gap-6 mb-6 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="dependent_relationship[]" value="{{ $dependent->relationship }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Spouse, Son, Daughter, etc." />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                class="dependent_birth_date bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                        </div>
                        <div>
