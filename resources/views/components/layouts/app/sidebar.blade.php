        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    @can('employees.list')
                    <flux:navlist.item icon="user-group" :href="route('employee.index')" :current="request()->routeIs('employee.index')" wire:navigate>{{ __('Employee Directory') }}</flux:navlist.item>
                    @endcan
                    ...
                    <flux:navlist.item icon="key" :href="route('roles.index')" :current="request()->routeIs('roles.index')" wire:navigate>{{ __('Roles and Permissions') }}</flux:navlist.item>
                    @endhasrole
                </flux:navlist.group>
            </flux:navlist>
